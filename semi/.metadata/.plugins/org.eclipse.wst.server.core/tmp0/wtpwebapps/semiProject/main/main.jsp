    ...
    <div class="wrapper">
        ...
        <ul class="nav">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-muted pr-0" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
             ...
             %>
              		<mark style="background-color:#eea303; color:#fff"><%= name %><span style="color:#fff">님</span> (<%= id %>)</mark>
             <%
             	} else {
             %>
              		<mark style="background-color:#1B68FE; color:#fff"><%= name %><span style="color:#fff">님</span> (<%= id %>)</mark>
             <%	
             	}
             %>
              </span>
      ...
      <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar navbar-light">
          ...
          <footer>
          	<main role="main" class="main-content footer">
