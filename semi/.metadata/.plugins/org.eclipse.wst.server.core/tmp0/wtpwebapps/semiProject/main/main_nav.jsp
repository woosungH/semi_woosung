	...
	<ul class="navbar-nav flex-fill w-100 mb-2">
        ...
        <li class="nav-item dropdown">
         ...
         <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
            <li class="nav-item">
              <a class="nav-link pl-3" href="main.jsp?pages=../product/product_list&category_code=t-shirt">
              <span class="ml-1 item-text">티셔츠</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link pl-3" href="main.jsp?pages=../product/product_list&category_code=hoodie">
              <span class="ml-1 item-text">후드티</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link pl-3" href="main.jsp?pages=../product/product_list&category_code=knit">
              <span class="ml-1 item-text">니트/스웨터</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link pl-3" href="main.jsp?pages=../product/product_list&category_code=shirt">
              <span class="ml-1 item-text">셔츠/남방</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link pl-3" href="main.jsp?pages=../product/product_list&category_code=pants">
              <span class="ml-1 item-text">바지</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link pl-3" href="main.jsp?pages=../product/product_list&category_code=blue-jeans">
              <span class="ml-1 item-text">청바지</span>
              </a>
            </li>
          </ul>
        </li>
        <li class="nav-item w-100">
          <a class="nav-link" href="main.jsp?pages=../cart/cartList">
            <i class="fe fe-truck fe-16"></i>
