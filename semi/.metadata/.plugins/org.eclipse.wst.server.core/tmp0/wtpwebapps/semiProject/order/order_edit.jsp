              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                      <form action="main.jsp?pages=../order/order_edit_ok&pageNum=<%= pageNum %>" method="post" name="order_frm">
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="order_detail_status" id="number" value="<%= omb.getOrder_detail_status() %>" readonly />
                          </div>
                          <div class="form-group col-md-3">
