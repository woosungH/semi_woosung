                    ...
                    <div class="card-body">
                      <form class="needs-validation" novalidate>
                        ...
                        <div style="text-align:center;">
							<input class="btn btn-primary" type="button" value="목록" onclick="location.href='main.jsp?pages=../cs/notice/noticeList_u&pageNum=<%=pageNum%>'">
						</div>
						...
						<%
							if(n_num+1 >0 ){
								...
								if(n_title2 != null){
						%>
										<a class="btn btn-primary" href="main.jsp?pages=../cs/notice/noticeShow&n_num=<%= n_after %>&pageNum=<%= pageNum %>" id="upPage">
											이전글 [<%= n_title2 %>]
										</a>
						<%
								}		
						...
						<%
							if(n_num-1 >0 ){
								...
								n_title2 = notice.getN_title();
						%>
									<a class="btn btn-primary" href="main.jsp?pages=../cs/notice/noticeShow&n_num=<%= n_before %>&pageNum=<%= pageNum %>" id="upPage">
										다음글 [<%= n_title2 %>]
									</a>
						<%
							}
